...
public class C04_Assertions {
    ...
    public void nutellaTest(){
        ...
        Assert.assertTrue("Sonuc Kutella icermiyor",actualSonucYazisi.contains(expectedSonucIcerik));
    }
    @Test
    public void javaTest(){
        ...
        String actualSonucYazisi = sonucYaziElementi.getText();
        Assert.assertTrue("Sonuc Hava icermiyor",actualSonucYazisi.contains(expectedSonucIcerik));
    }
}
